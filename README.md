...
The database has these columns: **Name, URL, Notes, Image** (files/media),
**Price** (number). Image and Price are filled in automatically from the
product page when you add an item by URL.
